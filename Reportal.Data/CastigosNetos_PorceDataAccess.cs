...
{
    public static class CastigosNetos_PorceDataAccess
    {
        public static List<CastigosNetos> ListarCastigosNetos_Trab_Porc()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_CastigoNeto_Trab_Porc", ConstructorEntidad);
        }
