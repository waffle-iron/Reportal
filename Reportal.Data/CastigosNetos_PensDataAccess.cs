...
{
    public static class CastigosNetos_PensDataAccess
    {
        public static List<CastigosNetos> ListarCastigosNetos_Pens()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_CastigoNeto_Pens", ConstructorEntidad);
        }
