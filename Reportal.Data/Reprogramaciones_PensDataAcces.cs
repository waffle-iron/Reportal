...
{
    public static class Reprogramaciones_PensDataAcces
    {
        public static List<Reprogramaciones> ListarProgramaciones_Pens()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_Reprogramaciones_Pens", ConstructorEntidad);
        }
