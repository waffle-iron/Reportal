...
{
    public static class EvolucionCamadas_12M_PensDataAccess
    {
        public static List<EvolucionCamadas_12M> ListarEvolucionCamada_12M_Pens()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_EvoCamadas_12M_Pens", ConstructorEntidad);
        }
