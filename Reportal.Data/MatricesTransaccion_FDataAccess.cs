...
{
    public static class MatricesTransaccion_FDataAccess
    {
        public static List<MatrizTransaccion> ListarMatrizTransaccion_F()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_MatricesTransicion_F", ConstructorEntidad);
        }
