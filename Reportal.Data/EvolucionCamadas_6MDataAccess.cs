...
{
    public static class EvolucionCamadas_6MDataAccess
    {
        public static List<EvolucionCamadas_6M> ListarEvolucionCamada_6M()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_EvoCamadas_6M_Trab", ConstructorEntidad);
        }
