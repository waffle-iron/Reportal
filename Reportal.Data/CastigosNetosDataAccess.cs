...
{
    public static class CastigosNetosDataAccess
    {
        public static List<CastigosNetos> ListarCastigosNetos_Trab()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_CastigoNeto_Trab", ConstructorEntidad);
        }
