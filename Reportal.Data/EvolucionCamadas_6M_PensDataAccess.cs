...
{
    public static class EvolucionCamadas_6M_PensDataAccess
    {
        public static List<EvolucionCamadas_6M> ListarEvolucionCamada_6M_Pens()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_EvoCamadas_6M_Pens", ConstructorEntidad);
        }
