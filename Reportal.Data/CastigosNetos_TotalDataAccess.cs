...
{
    public static class CastigosNetos_TotalDataAccess
    {
        public static List<CastigosNetos> ListarCastigosNetos_Total()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_CastigoNeto_Total", ConstructorEntidad);
        }
