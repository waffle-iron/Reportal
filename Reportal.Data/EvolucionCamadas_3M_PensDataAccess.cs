...
{
    public static class EvolucionCamadas_3M_PensDataAccess
    {
        public static List<EvolucionCamadas_3M> ListarEvolucionCamada_3M_Pens()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_EvoCamadas_3M_Pens", ConstructorEntidad);
        }
