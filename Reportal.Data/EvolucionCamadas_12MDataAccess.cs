...
{
    public static class EvolucionCamadas_12MDataAccess
    {
        public static List<EvolucionCamadas_12M> ListarEvolucionCamada_12M()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_EvoCamadas_12M_Trab", ConstructorEntidad);
        }
