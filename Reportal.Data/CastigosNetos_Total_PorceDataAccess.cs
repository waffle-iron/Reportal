...
{
    public static class CastigosNetos_Total_PorceDataAccess
    {
        public static List<CastigosNetos> ListarCastigosNetos_Total_Porce()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_CastigoNeto_Total_Porc", ConstructorEntidad);
        }
