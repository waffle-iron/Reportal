...
{
    public static class SeguroCesantia_TrabDataAcces
    {
        public static List<SeguroCesantia> ListarSeguro_Trab()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_SeguroCesantia_Trab", ConstructorEntidad);
        }
