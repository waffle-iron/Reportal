...
{
    public static class EvolucionCamadas_3MDataAccess
    {
        public static List<EvolucionCamadas_3M> ListarEvolucionCamada_3M()
        {
            return DBHelper.InstanceReporteria.ObtenerColeccion("sp_IndCredito_EvoCamadas_3M_Trab", ConstructorEntidad);
        }
